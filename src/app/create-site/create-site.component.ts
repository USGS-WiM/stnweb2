...
export class CreateSiteComponent implements OnInit {
    ...
    submitEvent(formValue) {
        ...
        formValue.location.coordinates = [
            formValue.location.coordinates.lat / 1,
            formValue.location.coordinates.long / 1,
        ];
        ...
        this.siteService.create(formValue).subscribe(
            (site) => {
                ...
                this.confirmDialogRef = this.dialog.open(ConfirmComponent, {
                    ...
                    data: {
                        ...
                        titleIcon: 'check',
                        message:
                            'Your site was successfully saved. The Site ID is ' +
                            site.id,
            ...
            (error) => {
                this.submitLoading = false;
                this.openSnackBar(
                    'Error. Site not Submitted. Error message: ' + error,
                    'OK',
                    8000
                );
